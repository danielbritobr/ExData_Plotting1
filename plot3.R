...
with(db, plot(new_date, Sub_metering_1, type = "n", xlab = "", ylab = "Energy sub metering"))
with(db, lines(new_date, Sub_metering_1, col = "grey"))
with(db, lines(new_date, Sub_metering_2, col = "red"))
with(db, lines(new_date, Sub_metering_3, col = "blue"))
